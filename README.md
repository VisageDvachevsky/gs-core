...
**Target Launch**: PHASE 4 (Feb 2026)
...
| **4** | Ввод: DataChannel + SendInput | 3–5 дней | 🟡 In Progress |
| **5** | Веб-клиент и оптимизация: production-ready | Текущая | 📋 Planning |

**Статус разработки**: Фаза 4 (Ввод: мышь/клавиатура/геймпад) 🟡
**Следующий шаг**: Реализация input pipeline через DataChannel + SendInput.
